...
func (this *IdGen) NextN(cnt int) ([]ItemId, error) {
	result := make([]ItemId, cnt)
...
func (id *IdGen) Next() (ItemId, error) {
...
func makeIdRange(time, nodeIdMask int64, elementId int64, result []ItemId, seqStart int32, seqEnd int32) []ItemId {
...
func makeId(time, nodeIdMask int64, elementId int64, seq int32) ItemId {
